  ...
  groups: [
    {
      ...
      rules: [
        ...
        // turn them into a single aggregated metric per operation.
        {
          ...
          record: 'backend_type_kubernetes_service_operation_storage_type:buildbarn_blobstore_blob_access_operations_started:irate5m',
        },
        {
        ...
        },
        {
          ...
          record: 'backend_type_kubernetes_service_le_operation_storage_type:buildbarn_blobstore_blob_access_operations_duration_seconds_bucket:irate5m',
        },
        {
          ...
          record: 'backend_type_grpc_code_kubernetes_service_storage_type:buildbarn_blobstore_blob_access_operations_duration_seconds_count:irate5m',
        },
        {
          ...
          record: 'backend_type_kubernetes_service_le_storage_type:buildbarn_blobstore_blob_access_operations_find_missing_batch_size_bucket:irate5m',
        },
        {
          ...
          record: 'backend_type_kubernetes_service_le_operation_storage_type:buildbarn_blobstore_blob_access_operations_blob_size_bytes_bucket:irate5m',
        },
        ...
        // Statistics on retention of centralized storage.
        {
          ...
          record: 'outcome_storage_type:buildbarn_blobstore_hashing_key_location_map_get_attempts_count:irate5m',
        },
        {
          ...
          record: 'storage_type:buildbarn_blobstore_hashing_key_location_map_get_too_many_attempts:irate5m',
        },
        {
          ...
          record: 'le_storage_type:buildbarn_blobstore_hashing_key_location_map_get_attempts_bucket:irate5m',
        },
        {
          ...
          record: 'storage_type:buildbarn_blobstore_hashing_key_location_map_put_ignored_invalid:irate5m',
        },
        {
          ...
          record: 'outcome_storage_type:buildbarn_blobstore_hashing_key_location_map_put_iterations_count:irate5m',
        },
        {
          ...
          record: 'storage_type:buildbarn_blobstore_hashing_key_location_map_put_too_many_iterations:irate5m',
        },
        {
          ...
          record: 'le_storage_type:buildbarn_blobstore_hashing_key_location_map_put_iterations_bucket:irate5m',
        },
        ...
        // Rate at which tasks are processed by the scheduler.
        {
          ...
          record: 'instance_name_prefix_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_queued:irate5m',
        },
        {
          ...
          record: 'instance_name_prefix_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_executing:irate5m',
        },
        {
          ...
          record: 'grpc_code_instance_name_prefix_platform_result_size_class:buildbarn_builder_in_memory_build_queue_tasks_completed:irate5m',
        },
        {
          ...
          record: 'instance_name_prefix_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_removed:irate5m',
        },
...

        {
          ...
          record: 'instance_name_prefix_le_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_queued_duration_seconds_bucket:irate5m',
        },
        {
          ...
          record: 'instance_name_prefix_le_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_executing_duration_seconds_bucket:irate5m',
        },
        {
          ...
          record: 'instance_name_prefix_le_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_completed_duration_seconds_bucket:irate5m',
        },
        {
          ...
          record: 'instance_name_prefix_le_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_executing_retries_bucket:irate5m',
        },
        ...
        },
        {
          ...
          record: 'kubernetes_service_le_operation:buildbarn_builder_build_executor_file_pool_operations_count_bucket:irate5m',
        },
        {
          ...
          record: 'kubernetes_service_le_operation:buildbarn_builder_build_executor_file_pool_operations_size_bytes_bucket:irate5m',
        },
        ...
        },
        {
          ...
          record: 'grpc_code_grpc_method_grpc_service_kubernetes_service:grpc_client_handled:irate5m',
        },
        {
          expr: 'sum(irate(grpc_client_msg_sent_total{}[5m])) by (cluster, namespace, grpc_method, grpc_service, app)',
          record: 'grpc_method_grpc_service_kubernetes_service:grpc_client_msg_sent:irate5m',
        },
        {
          expr: 'sum(irate(grpc_client_msg_received_total{}[5m])) by (cluster, namespace, grpc_method, grpc_service, app)',
          record: 'grpc_method_grpc_service_kubernetes_service:grpc_client_msg_received:irate5m',
        },
        {
          expr: 'sum(irate(grpc_client_handling_seconds_bucket{}[5m])) by (cluster, namespace, grpc_method, grpc_service, app, le)',
          record: 'grpc_method_grpc_service_kubernetes_service_le:grpc_client_handling_seconds_bucket:irate5m',
        },
        ...
        },
        {
          ...
          record: 'grpc_method_grpc_service_kubernetes_service:grpc_server_handled:irate5m',
        },
        {
          expr: 'sum(irate(grpc_server_handled_total{}[5m])) by (cluster, namespace, grpc_code, grpc_method, grpc_service, app)',
          record: 'grpc_code_grpc_method_grpc_service_kubernetes_service:grpc_server_handled:irate5m',
        },
        {
          expr: 'sum(irate(grpc_server_msg_sent_total{}[5m])) by (cluster, namespace, grpc_method, grpc_service, app)',
          record: 'grpc_method_grpc_service_kubernetes_service:grpc_server_msg_sent:irate5m',
        },
        {
          expr: 'sum(irate(grpc_server_msg_received_total{}[5m])) by (cluster, namespace, grpc_method, grpc_service, app)',
          record: 'grpc_method_grpc_service_kubernetes_service:grpc_server_msg_received:irate5m',
        },
        {
          expr: 'sum(irate(grpc_server_handling_seconds_bucket{}[5m])) by (cluster, namespace, grpc_method, grpc_service, app, le)',
          record: 'grpc_method_grpc_service_kubernetes_service_le:grpc_server_handling_seconds_bucket:irate5m',
        },
      ],
    },
  ],
