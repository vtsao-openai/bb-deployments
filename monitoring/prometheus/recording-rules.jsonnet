  ...
  groups: [
    {
      ...
      rules: [
        ...
        {
          expr: 'sum(irate(buildbarn_blobstore_blob_access_operations_blob_size_bytes_count{}[1m])) by (cluster, namespace, backend_type, app, operation, storage_type)',
          record: 'backend_type_kubernetes_service_operation_storage_type:buildbarn_blobstore_blob_access_operations_started:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_blobstore_blob_access_operations_find_missing_batch_size_count{}[1m])) by (cluster, namespace, backend_type, app, storage_type)',
          labels: {
        ...
        {
          expr: 'sum(irate(buildbarn_blobstore_blob_access_operations_duration_seconds_bucket{}[1m])) by (cluster, namespace, backend_type, app, le, operation, storage_type)',
        ...
        {
          expr: 'sum(irate(buildbarn_blobstore_blob_access_operations_duration_seconds_count{}[1m])) by (cluster, namespace, backend_type, grpc_code, app, storage_type)',
        ...
        {
          expr: 'sum(irate(buildbarn_blobstore_blob_access_operations_find_missing_batch_size_bucket{}[1m])) by (cluster, namespace, backend_type, app, le, storage_type)',
        ...
        {
          expr: 'sum(irate(buildbarn_blobstore_blob_access_operations_blob_size_bytes_bucket{}[1m])) by (cluster, namespace, backend_type, app, le, operation, storage_type)',
        ...
        {
          expr: 'sum(irate(buildbarn_blobstore_hashing_key_location_map_get_attempts_count{app="storage"}[1m])) by (cluster, namespace, storage_type, outcome)',
          record: 'outcome_storage_type:buildbarn_blobstore_hashing_key_location_map_get_attempts_count:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_blobstore_hashing_key_location_map_get_too_many_attempts_total{app="storage"}[1m])) by (cluster, namespace, storage_type)',
          record: 'storage_type:buildbarn_blobstore_hashing_key_location_map_get_too_many_attempts:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_blobstore_hashing_key_location_map_get_attempts_bucket{app="storage"}[1m])) by (cluster, namespace, le, storage_type)',
          record: 'le_storage_type:buildbarn_blobstore_hashing_key_location_map_get_attempts_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_blobstore_hashing_key_location_map_put_ignored_invalid_total{app="storage"}[1m])) by (cluster, namespace, storage_type)',
          record: 'storage_type:buildbarn_blobstore_hashing_key_location_map_put_ignored_invalid:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_blobstore_hashing_key_location_map_put_iterations_count{app="storage"}[1m])) by (cluster, namespace, outcome, storage_type)',
          record: 'outcome_storage_type:buildbarn_blobstore_hashing_key_location_map_put_iterations_count:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_blobstore_hashing_key_location_map_put_too_many_iterations_total{app="storage"}[1m])) by (cluster, namespace, storage_type)',
          record: 'storage_type:buildbarn_blobstore_hashing_key_location_map_put_too_many_iterations:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_blobstore_hashing_key_location_map_put_iterations_bucket{app="storage"}[1m])) by (cluster, namespace, le, storage_type)',
        ...
        {
          expr: 'sum(irate(buildbarn_builder_in_memory_build_queue_tasks_scheduled_total{app="scheduler"}[1m])) by (cluster, namespace, instance_name_prefix, platform, size_class)',
          record: 'instance_name_prefix_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_queued:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_in_memory_build_queue_tasks_queued_duration_seconds_count{app="scheduler"}[1m])) by (cluster, namespace, instance_name_prefix, platform, size_class)',
          record: 'instance_name_prefix_platform_size_class:buildbarn_builder_in_memory_build_queue_tasks_executing:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_in_memory_build_queue_tasks_executing_duration_seconds_count{app="scheduler"}[1m])) by (cluster, namespace, grpc_code, instance_name_prefix, platform, result, size_class)',
        ...
        {
          expr: 'sum(irate(buildbarn_builder_in_memory_build_queue_tasks_completed_duration_seconds_count{app="scheduler"}[1m])) by (cluster, namespace, instance_name_prefix, platform, size_class)',
        ...
        {
          expr: 'sum(irate(buildbarn_builder_in_memory_build_queue_tasks_queued_duration_seconds_bucket{app="scheduler"}[1m])) by (cluster, namespace, instance_name_prefix, le, platform, size_class)',
        ...
        {
          expr: 'sum(irate(buildbarn_builder_in_memory_build_queue_tasks_executing_duration_seconds_bucket{app="scheduler"}[1m])) by (cluster, namespace, instance_name_prefix, le, platform, size_class)',
        ...
        {
          expr: 'sum(irate(buildbarn_builder_in_memory_build_queue_tasks_completed_duration_seconds_bucket{app="scheduler"}[1m])) by (cluster, namespace, instance_name_prefix, le, platform, size_class)',
        ...
        {
          expr: 'sum(irate(buildbarn_builder_in_memory_build_queue_tasks_executing_retries_bucket{app="scheduler"}[1m])) by (cluster, namespace, instance_name_prefix, le, platform, size_class)',
        ...
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_duration_seconds_count{}[1m])) by (cluster, namespace, app)',
          record: 'kubernetes_service:buildbarn_builder_build_executor_operations:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_duration_seconds_bucket{}[1m])) by (cluster, namespace, app, le, stage)',
          record: 'kubernetes_service_le_stage:buildbarn_builder_build_executor_duration_seconds_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_virtual_execution_duration_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_virtual_execution_duration_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_user_time_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_user_time_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_system_time_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_system_time_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_maximum_resident_set_size_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_maximum_resident_set_size_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_page_reclaims_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_page_reclaims_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_page_faults_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_page_faults_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_swaps_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_swaps_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_block_input_operations_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_block_input_operations_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_block_output_operations_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_block_output_operations_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_messages_sent_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_messages_sent_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_messages_received_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_messages_received_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_signals_received_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_signals_received_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_voluntary_context_switches_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_voluntary_context_switches_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_posix_involuntary_context_switches_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_posix_involuntary_context_switches_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_file_pool_files_created_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_file_pool_files_created_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_file_pool_files_count_peak_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_file_pool_files_count_peak_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_file_pool_files_size_bytes_peak_bucket{}[1m])) by (cluster, namespace, app, le)',
          record: 'kubernetes_service_le:buildbarn_builder_build_executor_file_pool_files_size_bytes_peak_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_file_pool_operations_count_bucket{}[1m])) by (cluster, namespace, app, le, operation)',
          record: 'kubernetes_service_le_operation:buildbarn_builder_build_executor_file_pool_operations_count_bucket:irate1m',
        },
        {
          expr: 'sum(irate(buildbarn_builder_build_executor_file_pool_operations_size_bytes_bucket{}[1m])) by (cluster, namespace, app, le, operation)',
        ...
        {
          expr: 'sum(irate(grpc_client_handled_total{}[1m])) by (cluster, namespace, grpc_code, grpc_method, grpc_service, app)',
          record: 'grpc_code_grpc_method_grpc_service_kubernetes_service:grpc_client_handled:irate1m',
        },
        {
          expr: 'sum(irate(grpc_client_msg_sent_total{}[1m])) by (cluster, namespace, grpc_method, grpc_service, app)',
          record: 'grpc_method_grpc_service_kubernetes_service:grpc_client_msg_sent:irate1m',
        },
        {
          expr: 'sum(irate(grpc_client_msg_received_total{}[1m])) by (cluster, namespace, grpc_method, grpc_service, app)',
          record: 'grpc_method_grpc_service_kubernetes_service:grpc_client_msg_received:irate1m',
        },
        {
          expr: 'sum(irate(grpc_client_handling_seconds_bucket{}[1m])) by (cluster, namespace, grpc_method, grpc_service, app, le)',
        ...
        {
          expr: 'sum(irate(grpc_server_handled_total{}[1m])) by (cluster, namespace, grpc_method, grpc_service, app)',
          record: 'grpc_method_grpc_service_kubernetes_service:grpc_server_handled:irate1m',
        },
        {
          expr: 'sum(irate(grpc_server_handled_total{}[1m])) by (cluster, namespace, grpc_code, grpc_method, grpc_service, app)',
          record: 'grpc_code_grpc_method_grpc_service_kubernetes_service:grpc_server_handled:irate1m',
        },
        {
          expr: 'sum(irate(grpc_server_msg_sent_total{}[1m])) by (cluster, namespace, grpc_method, grpc_service, app)',
          record: 'grpc_method_grpc_service_kubernetes_service:grpc_server_msg_sent:irate1m',
        },
        {
          expr: 'sum(irate(grpc_server_msg_received_total{}[1m])) by (cluster, namespace, grpc_method, grpc_service, app)',
          record: 'grpc_method_grpc_service_kubernetes_service:grpc_server_msg_received:irate1m',
        },
        {
          expr: 'sum(irate(grpc_server_handling_seconds_bucket{}[1m])) by (cluster, namespace, grpc_method, grpc_service, app, le)',
